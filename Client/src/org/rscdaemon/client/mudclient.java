...
//Ok
    ...
    private final void drawAbuseWindow1() {
        ...
        gameGraphics.drawText("5: RSCDaemon Staff impersonation", 256, i, 1, k);
        i += 14;
...
//                                showServerMessageBox = false;
    ...
    private final void makeLoginMenus() {
        ...
        int i = 40;
        menuWelcome.drawText(256, 200 + i, "Welcome to RSCDaemon", 4, true);
        ...
        i += 30;
        menuLogin.drawBox(410, i, 120, 25);
        menuLogin.drawText(410, i, "", 4, false);
